...
class SwapingHistoryFiltterAdapter2(val context: Context, var countrymodedata: ArrayList<SwapingFiltteringArrayResponse>,
                                    internal var mCustomOnClickListener: rideCustomOnClickListener
) :
    RecyclerView.Adapter<SwapingHistoryFiltterAdapter2.ViewHolder>() {
