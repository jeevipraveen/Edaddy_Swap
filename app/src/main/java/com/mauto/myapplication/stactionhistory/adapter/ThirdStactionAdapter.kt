...
class ThirdStactionAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    RecyclerView.Adapter<ThirdStactionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ThirdStactionAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.third_staction_adapter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: ThirdStactionAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
