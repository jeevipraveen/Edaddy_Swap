...
class FirstStactionAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    RecyclerView.Adapter<FirstStactionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FirstStactionAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.first_staction_adapter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: FirstStactionAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
