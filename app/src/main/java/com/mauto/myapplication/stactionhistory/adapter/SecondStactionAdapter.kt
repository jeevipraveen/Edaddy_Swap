...
class SecondStactionAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    RecyclerView.Adapter<SecondStactionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SecondStactionAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.second_staction_adapter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: SecondStactionAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
