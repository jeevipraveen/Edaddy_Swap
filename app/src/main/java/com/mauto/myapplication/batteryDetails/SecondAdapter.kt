...
class SecondAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SecondAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.second_adpter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: SecondAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
