...
class FirstAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FirstAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.first_adapter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: FirstAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
