...
class FourthAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FourthAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.fourth_adapter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: FourthAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
