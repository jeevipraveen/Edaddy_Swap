...
class ThirdAdapter(val ctx: Context, var data: List<StactionBatteryArrayResponse>
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ThirdAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.third_adapter, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: ThirdAdapter.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
